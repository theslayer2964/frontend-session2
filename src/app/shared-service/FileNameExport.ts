...
export const DS_Nhom_KLTN = 'DS_Nhom_KLTN';
export const DanhSach_DeTai_KLTN = 'DanhSach_DeTai_KLTN';
export const DS_Nhom_KLTN_RA_HD_POSTER = 'DS_Nhom_KLTN_RA_HD_POSTER';
export const MailMerge_PhieuChamHD = 'MailMerge_PhieuCham_HuongDan';
